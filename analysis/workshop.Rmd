...
Download `sra.r` from <https://sites.google.com/site/hardlyanydata> and source it into R. Set `RStudio = TRUE` for use within RStudio and save the file. The library also requires the package `sn`. Use `rm(list = ls())` to clear R enviornment.
